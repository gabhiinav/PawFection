...
function Home() {
  ...
  return (
    <>
        ...
        <div class="hidden md:flex items-center space-x-1">
          <Link to="/" class="py-5 px-3">Profile</Link>
      ...
      <div className='w-full h-[600px] text-white'>
        <div className='w-full h-full'>
          ...
          <img
            ...
            src={`https://images.unsplash.com/photo-1605001011156-cbf0b0f67a51?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2874&q=80`}
            alt="image"
          />
          <div className='absolute w-full top-[30%] p-4 md:p-8'>
            <h1 className='text-3xl md:text-5xl font-bold text-center'>Find trusted, local Pet Sitters & Dog Walkers.</h1>
            <br />
            <br />
            <br />
      ...
      <section class="bg-gray-100">
        ...
        <p class="mt-8 text-base leading-6 text-center text-gray-400">
            © 2023 Pawfection, Inc. All rights reserved.
        </p>
      </div>
      </section>
    </div>
